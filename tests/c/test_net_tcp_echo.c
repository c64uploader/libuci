 ...
 *
 * test_net_tcp_echo.c - TCP echo test.
 *
 * The Go harness starts a TCP echo server and writes its IP + port
...
static const char *test_msg = "HELLO FROM C64 TCP!";
...
int main(void) {
    ...
    *p = '\0';
    ...
    /* Open TCP connection to echo server */
    printf("  OPENING TCP %s:%d...\n", host, port);
